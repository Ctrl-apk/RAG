...
const wiki = wikiLib.default || wikiLib;
...
export const wikipediaTool = new DynamicStructuredTool({
    ...
    description: "Search Wikipedia for external information when document context is irrelevant or missing. " +
...
export function createRetrieveTool(docId, tracker) {
